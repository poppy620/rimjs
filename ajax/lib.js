...
function requestSend(param, course) {
    return __awaiter(this, void 0, void 0, function () {
        var req, httpReg, method, isFormData, dataType, para;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!req.awaitPath) return [3 /*break*/, 2];
                    // 有等待函数， 则 异步处理
                    return [4 /*yield*/, req.awaitPath(course)];
                case 1:
                    // 有等待函数， 则 异步处理
                    _a.sent();
                    _a.label = 2;
                case 2:
                    ...
                    method = (req.method = String(req.method || "get").toUpperCase());
                    isFormData = req.isFormData;
                    dataType = (req.dataType = String(req.dataType || "").toLowerCase());
                    // 数据整理完成
